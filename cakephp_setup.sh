...
# 
# Can be used to setup a minimal CentOS machine to be used
# for a CakePHP application ready Vagrant Box
#
...
# SETUP MEMCACHE
#
# Memcache for a speedy PHP-FPM like in production
##
...
# SETUP PHP-FPM 
#
# This part of the script also symlinks the /usr/share/nginx/html
# to the /vagrant shared folder.
#
# We also writeout our own php.ini, apc.ini and www.conf files for PHP
# and PHP-FPM. Comments in these files should be left intact for obvious
# reasons.
##
...
mkdir /usr/share/nginx/html/app/webroot
...
cat > /usr/share/nginx/html/app/webroot/index.php <<"EOF"
<html>
<head>
	<title>CentOS Vagrent Box</title>
</head>
<body>
	<h1>CentOS Vagrent Box</h1>
	<em>From: <a href="https://github.com/Label305/vagrant-centos">https://github.com/Label305/vagrant-centos</a></em>
	<p>Box for a Nginx, PHP-FPM (Memcache), MySQL, CakePHP setup.</p>
	<p>All services start on startup. The linux root password is <strong>vagrant</strong>.</p>
	<p>MySQL <strong>vagrant</strong> user created with password <strong>vagrantmysqlpassword</strong>. MySQL is running on 3306.</p>
	<p>To get started execute the following code:<br /><strong>
	rm -rf /usr/share/nginx/html<br />
	ln -fs /vagrant /usr/share/nginx/html<br />
	chmod -R g+rw /usr/share/nginx/html<br />
	chown -R www:www /usr/share/nginx<br />
...
# setting up all the config files needed
# CakePHP setup by default so webroot is /app/webroot
##
